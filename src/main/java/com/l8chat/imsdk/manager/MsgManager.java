package com.l8chat.imsdk.manager;
...
import com.l8chat.imsdk.WKIM;
import com.l8chat.imsdk.WKIMApplication;
import com.l8chat.imsdk.db.ConversationDbManager;
import com.l8chat.imsdk.db.MsgDbManager;
import com.l8chat.imsdk.db.WKDBColumns;
import com.l8chat.imsdk.entity.WKChannel;
import com.l8chat.imsdk.entity.WKChannelType;
import com.l8chat.imsdk.entity.WKConversationMsg;
import com.l8chat.imsdk.entity.WKMentionInfo;
import com.l8chat.imsdk.entity.WKMessageGroupByDate;
import com.l8chat.imsdk.entity.WKMessageSearchResult;
import com.l8chat.imsdk.entity.WKMsg;
import com.l8chat.imsdk.entity.WKMsgExtra;
import com.l8chat.imsdk.entity.WKMsgReaction;
import com.l8chat.imsdk.entity.WKMsgSetting;
import com.l8chat.imsdk.entity.WKSendOptions;
import com.l8chat.imsdk.entity.WKSyncExtraMsg;
import com.l8chat.imsdk.entity.WKSyncMsg;
import com.l8chat.imsdk.entity.WKSyncMsgReaction;
import com.l8chat.imsdk.entity.WKSyncRecent;
import com.l8chat.imsdk.entity.WKUIConversationMsg;
import com.l8chat.imsdk.interfaces.IClearMsgListener;
import com.l8chat.imsdk.interfaces.IDeleteMsgListener;
import com.l8chat.imsdk.interfaces.IGetOrSyncHistoryMsgBack;
import com.l8chat.imsdk.interfaces.IMessageStoreBeforeIntercept;
import com.l8chat.imsdk.interfaces.INewMsgListener;
import com.l8chat.imsdk.interfaces.IRefreshMsg;
import com.l8chat.imsdk.interfaces.ISendACK;
import com.l8chat.imsdk.interfaces.ISendMsgCallBackListener;
import com.l8chat.imsdk.interfaces.ISyncChannelMsgBack;
import com.l8chat.imsdk.interfaces.ISyncChannelMsgListener;
import com.l8chat.imsdk.interfaces.ISyncOfflineMsgBack;
import com.l8chat.imsdk.interfaces.ISyncOfflineMsgListener;
import com.l8chat.imsdk.interfaces.IUploadAttacResultListener;
import com.l8chat.imsdk.interfaces.IUploadAttachmentListener;
import com.l8chat.imsdk.interfaces.IUploadMsgExtraListener;
import com.l8chat.imsdk.message.MessageHandler;
import com.l8chat.imsdk.message.WKConnection;
import com.l8chat.imsdk.message.type.WKMsgContentType;
import com.l8chat.imsdk.message.type.WKSendMsgResult;
import com.l8chat.imsdk.msgmodel.WKFormatErrorContent;
import com.l8chat.imsdk.msgmodel.WKImageContent;
import com.l8chat.imsdk.msgmodel.WKMessageContent;
import com.l8chat.imsdk.msgmodel.WKMsgEntity;
import com.l8chat.imsdk.msgmodel.WKReply;
import com.l8chat.imsdk.msgmodel.WKTextContent;
import com.l8chat.imsdk.msgmodel.WKVideoContent;
import com.l8chat.imsdk.msgmodel.WKVoiceContent;
import com.l8chat.imsdk.utils.DateUtils;
import com.l8chat.imsdk.utils.WKCommonUtils;
import com.l8chat.imsdk.utils.WKLoggerUtils;
import com.l8chat.imsdk.utils.WKTypeUtils;
