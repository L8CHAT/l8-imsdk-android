package com.l8chat.imsdk.message;
...
import com.l8chat.imsdk.entity.WKConversationMsgExtra;
import com.l8chat.imsdk.entity.WKMsg;
import com.l8chat.imsdk.entity.WKMsgSetting;
import com.l8chat.imsdk.entity.WKSyncMsgMode;
import com.l8chat.imsdk.entity.WKUIConversationMsg;
import com.l8chat.imsdk.interfaces.IReceivedMsgListener;
import com.l8chat.imsdk.manager.ConnectionManager;
import com.l8chat.imsdk.message.timer.HeartbeatManager;
import com.l8chat.imsdk.message.timer.NetworkChecker;
import com.l8chat.imsdk.message.timer.TimerManager;
import com.l8chat.imsdk.message.type.WKConnectReason;
import com.l8chat.imsdk.message.type.WKConnectStatus;
import com.l8chat.imsdk.message.type.WKMsgType;
import com.l8chat.imsdk.message.type.WKSendMsgResult;
import com.l8chat.imsdk.message.type.WKSendingMsg;
import com.l8chat.imsdk.msgmodel.WKImageContent;
import com.l8chat.imsdk.msgmodel.WKMediaMessageContent;
import com.l8chat.imsdk.msgmodel.WKVideoContent;
import com.l8chat.imsdk.protocol.WKBaseMsg;
import com.l8chat.imsdk.protocol.WKConnectAckMsg;
import com.l8chat.imsdk.protocol.WKConnectMsg;
...
import com.l8chat.imsdk.utils.DispatchQueuePool;
import com.l8chat.imsdk.utils.FileUtils;
